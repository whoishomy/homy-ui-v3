...
export const ThemeLanguageSelector = ({ currentLanguage, onLanguageChange }: Props) => {
    ...
    <div className="flex items-center gap-2 p-4 rounded-xl bg-gray-50 dark:bg-gray-800">
      ...
      <div className="relative group">
        ...
        <div className="absolute top-full left-0 mt-1 w-40 py-1 bg-white dark:bg-gray-800 rounded-lg shadow-lg ring-1 ring-gray-200 dark:ring-gray-700 invisible group-hover:visible">
          <ul role="listbox" className="py-1" aria-label="Dil seçimi">
            {languages.map((lang) => {
              ...
              return (
                <li
                  ...
                  className="w-full px-4 py-2 text-left text-sm hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 flex items-center gap-2 cursor-pointer"
                >
                  <span>{lang.flag}</span>
                  <span>{lang.name}</span>
                </li>
