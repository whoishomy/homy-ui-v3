...
jest.mock('@/components/settings/ThemeLanguageSelector', () => ({
  ThemeLanguageSelector: () => (
    <div data-testid="theme-language-selector">Theme Language Selector</div>
  ),
}));

jest.mock('@/components/settings/UserProfileForm', () => ({
